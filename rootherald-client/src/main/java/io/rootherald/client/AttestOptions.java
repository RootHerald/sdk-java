...
/**
 * Options for {@link BackgroundCheckClient#attest(String, AttestOptions)}.
 * <p>
...
public final class AttestOptions {
    ...
    private AttestOptions(String challengeId, String policy, boolean returnToken) {
        if (challengeId == null || challengeId.isEmpty()) {
            throw new IllegalArgumentException("challengeId is required (from createChallenge)");
        }
    ...
    /** The single-use challenge id from {@link BackgroundCheckClient#createChallenge()}. */
